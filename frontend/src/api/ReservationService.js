...
export const ReservationService = {
  ...
  updateParticipant: (reservationId, participantId, data) => 
    apiClient.put(`/api/reservations/${reservationId}/participants/${participantId}/`, data),
  deleteParticipant: (reservationId, participantId) => 
    apiClient.delete(`/api/reservations/${reservationId}/participants/${participantId}/`),
};
